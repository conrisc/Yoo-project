                ...
                <div className="row py-2">
                    ...
                    <form className="col simple-form">
                        <div className="form-group">
                            ...
                            type="text" placeholder="What's your starting point?" name="startingPoint" onChange={e => this.startpointChange(e)}/>
                        </div>
                        <div className="form-group">
                            ...
                            name="destinationPoint" onChange={e => this.startpointChange(e)} />
                        </div>
                        <button onClick={(e) => this.find(e)}>Find</button>
                        <div className="form-group">
                            <label className="col-form-label col-form-label-sm">Transport</label><br />
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="transportType" id="ownTransport" value="OWN"
                                onChange={e=> this.handleTransportTypeChange(e)}/>
                                <label className="form-check-label col-form-label-sm" htmlFor="ownTransport">Everyone on its own</label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="radio" name="transportType" id="providedTransport" value="PROVIDED"
                                onChange={e=> this.handleTransportTypeChange(e)}/>
                        ...
                        <div className={'form-group ' + this.state.transportTypeClass}>
                            ...
                            <select id="selectTransportType" className="form-control form-control-sm">
                                <option defaultValue="true">Car</option>
                                <option>Bus</option>
                                <option>Plane</option>
                            </select>
                        </div>
